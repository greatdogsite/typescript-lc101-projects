...
// console.log(`It will take ${spacecraftName} ${getDaysToLocation(kilometersToMars)} to reach Mars.`);
...
console.log("It will take ".concat(spaceShuttle.name, " ").concat(spaceShuttle.getDaysToLocation(kilometersToMars), " to reach Mars."));
console.log("It will take ".concat(spaceShuttle.name, " ").concat(spaceShuttle.getDaysToLocation(kilometersToTheMoon), " to reach the Moon."));
